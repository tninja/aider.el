...
(defconst aider-mcp--sequential-thinking-tool-description-prompt
...
;;;###autoload
(defun aider-start-mcp-sequential-thinking ()
...
`aider-mcp--sequential-thinking-tool-description-prompt`."
  (interactive)
