...
- Add aider-add-module function, it will add files with suffix in the module directory to aider session. It is useful for adding module files to aider session.
