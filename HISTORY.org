...
- Add aider-thinking-planning.el, it provides two functions:
  - aider-start-sequential-thinking: start a sequential thinking session with Aider
  - aider-start-software-planning: start a software planning session with Aider
